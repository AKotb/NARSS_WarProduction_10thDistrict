		...
		<div align="center">
			<table id="tables" border="1" cellpadding="15"
				...
				<c:forEach var="authorization" items="${msg}">
					...
					<c:url var="getauthorizationdatalink" value="getauthorization">
						<c:param name="madn" value="${authorization.maDelegationNo}"></c:param>
					</c:url>
					<tr>
						<td style="text-align: center"><a href="${deletelink}">حذف</a>&nbsp;&nbsp;&nbsp;<a href="${getauthorizationdatalink}">تعديل</a></td>
